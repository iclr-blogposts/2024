...
The posts will be created and published under a unified template; see [the submission instructions]({{ '/submitting' | relative_url }}) and the [sample post]({% post_url 2024-05-07-Unraveling-The-Impact-of-Training-Samples %}) hosted on the blog of this website.
