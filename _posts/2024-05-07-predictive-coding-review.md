...
description: Predictive Coding Networks (PCN) have become an important subfield at the intersection of neuroscience and machine learning, which has enjoyed growing attention in recent years. Unfortunately, mathematics, to date, is largely missing from this intersection.
In this blog post, we want to highlight the benefits that a more mathematical treatment of existing predictive coding networks can offer, review several important papers published in the past at major conferences, and reformulate and illustrate their results in a more formal manner. One particular focus in this blog post is on simplicity: The full framework, often presented by hard-to-read formulas -or perhaps only code- makes it often difficult to read the article, in particular for newcomers to the field. We focus here on illustrating the frameworks with simple, toy examples that often already capture most of the essential ideas, but are joyful to read.
date: 2024-05-07
future: true
htmlwidgets: true
