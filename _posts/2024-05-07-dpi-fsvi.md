...
<aside class="box-warning" markdown>
...
<details markdown="1">
<summary markdown="1"><span>Details</span>
<div>
This blog post uses the same background as the previous blog post ["Bayesian Appropriation: General Likelihood for Loss Functions"](https://blog.blackhc.net/2023/06/general_likelihood/), so you can skip it if you have read the previous blog posts.</div></summary>
...
<aside markdown class="box-warning">
